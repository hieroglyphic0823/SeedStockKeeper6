...
// ---------- Tanesuke Light Scheme ----------
val tanesukeLightScheme = lightColorScheme(
    primary = primaryTanesukeLight,
    onPrimary = onPrimaryTanesukeLight,
    primaryContainer = primaryContainerTanesukeLight,
    onPrimaryContainer = onPrimaryContainerTanesukeLight,
    secondary = secondaryTanesukeLight,
    onSecondary = onSecondaryTanesukeLight,
    secondaryContainer = secondaryContainerTanesukeLight,
    onSecondaryContainer = onSecondaryContainerTanesukeLight,
    tertiary = tertiaryTanesukeLight,
    onTertiary = onTertiaryTanesukeLight,
    tertiaryContainer = tertiaryContainerTanesukeLight,
    onTertiaryContainer = onTertiaryContainerTanesukeLight,
    error = errorTanesukeLight,
    onError = onErrorTanesukeLight,
    errorContainer = errorContainerTanesukeLight,
    onErrorContainer = onErrorContainerTanesukeLight,
    background = backgroundTanesukeLight,
    onBackground = onBackgroundTanesukeLight,
    surface = surfaceTanesukeLight,
    onSurface = onSurfaceTanesukeLight,
    surfaceVariant = surfaceVariantTanesukeLight,
    onSurfaceVariant = onSurfaceVariantTanesukeLight,
    outline = outlineTanesukeLight,
    outlineVariant = outlineVariantTanesukeLight,
    scrim = scrimTanesukeLight,
    inverseSurface = inverseSurfaceTanesukeLight,
    inverseOnSurface = inverseOnSurfaceTanesukeLight,
    inversePrimary = inversePrimaryTanesukeLight,
    surfaceDim = surfaceDimTanesukeLight,
    surfaceBright = surfaceBrightTanesukeLight,
    surfaceContainerLowest = surfaceContainerLowestTanesukeLight,
    surfaceContainerLow = surfaceContainerLowTanesukeLight,
    surfaceContainer = surfaceContainerTanesukeLight,
    surfaceContainerHigh = surfaceContainerHighTanesukeLight,
    surfaceContainerHighest = surfaceContainerHighestTanesukeLight,
)

// ---------- Tanesuke Dark Scheme ----------
val tanesukeDarkScheme = darkColorScheme(
    primary = primaryTanesukeDark,
    onPrimary = onPrimaryTanesukeDark,
    primaryContainer = primaryContainerTanesukeDark,
    onPrimaryContainer = onPrimaryContainerTanesukeDark,
    secondary = secondaryTanesukeDark,
    onSecondary = onSecondaryTanesukeDark,
    secondaryContainer = secondaryContainerTanesukeDark,
    onSecondaryContainer = onSecondaryContainerTanesukeDark,
    tertiary = tertiaryTanesukeDark,
    onTertiary = onTertiaryTanesukeDark,
    tertiaryContainer = tertiaryContainerTanesukeDark,
    onTertiaryContainer = onTertiaryContainerTanesukeDark,
    error = errorTanesukeDark,
    onError = onErrorTanesukeDark,
    errorContainer = errorContainerTanesukeDark,
    onErrorContainer = onErrorContainerTanesukeDark,
    background = backgroundTanesukeDark,
    onBackground = onBackgroundTanesukeDark,
    surface = surfaceTanesukeDark,
    onSurface = onSurfaceTanesukeDark,
    surfaceVariant = surfaceVariantTanesukeDark,
    onSurfaceVariant = onSurfaceVariantTanesukeDark,
    outline = outlineTanesukeDark,
    outlineVariant = outlineVariantTanesukeDark,
    scrim = scrimTanesukeDark,
    inverseSurface = inverseSurfaceTanesukeDark,
    inverseOnSurface = inverseOnSurfaceTanesukeDark,
    inversePrimary = inversePrimaryTanesukeDark,
    surfaceDim = surfaceDimTanesukeDark,
    surfaceBright = surfaceBrightTanesukeDark,
    surfaceContainerLowest = surfaceContainerLowestTanesukeDark,
    surfaceContainerLow = surfaceContainerLowTanesukeDark,
    surfaceContainer = surfaceContainerTanesukeDark,
    surfaceContainerHigh = surfaceContainerHighTanesukeDark,
    surfaceContainerHighest = surfaceContainerHighestTanesukeDark,
)
