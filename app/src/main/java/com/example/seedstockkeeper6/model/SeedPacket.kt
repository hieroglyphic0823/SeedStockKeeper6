...
data class SeedPacket(
    ...
    @get:PropertyName("sowingEventId")
    val sowingEventId: String = "",   // 播種期間のイベントID（Googleカレンダー）
    @get:PropertyName("harvestEventId")
    val harvestEventId: String = "",  // 収穫期間のイベントID（Googleカレンダー）
    @get:PropertyName("plantedEventId")
    val plantedEventId: String = ""  // 実際にまいた日のイベントID（Googleカレンダー）
) {
